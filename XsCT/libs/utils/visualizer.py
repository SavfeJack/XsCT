...
def main():
  from XsCT.libs.dataset.data_augmentation import CT_Data_Augmentation, Xray_Data_Augmentation
  test_file = r''
  import h5py

  from XsCT.libs.config.config import cfg, merge_dict_and_yaml
